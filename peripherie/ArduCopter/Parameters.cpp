 ...
 */
const AP_Param::ConversionInfo conversion_table[] PROGMEM = { { Parameters::k_param_battery_monitoring, 0, AP_PARAM_INT8, "BATT_MONITOR" }, { Parameters::k_param_battery_volt_pin, 0, AP_PARAM_INT8, "BATT_VOLT_PIN" }, { Parameters::k_param_battery_curr_pin,
    0, AP_PARAM_INT8, "BATT_CURR_PIN" }, { Parameters::k_param_volt_div_ratio, 0, AP_PARAM_FLOAT, "BATT_VOLT_MULT" }, { Parameters::k_param_curr_amp_per_volt, 0, AP_PARAM_FLOAT, "BATT_AMP_PERVOLT" }, { Parameters::k_param_pack_capacity, 0, AP_PARAM_INT32,
    "BATT_CAPACITY" }, };
...
if (!g.format_version.load() || g.format_version != Parameters::k_format_version) {
	...
	hal.console->println_P(PSTR("Firmware change: erasing EEPROM...\n"));
	AP_Param::erase_all();
	...
	hal.console->_printf_P((const prog_char *) PSTR("load_all took %luus\n"), micros() - before);
}
}
