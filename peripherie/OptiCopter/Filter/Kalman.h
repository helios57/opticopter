...
public:
	Kalman() {
		Q_angle = 0.00001; // Process noise variance for the accelerometer
		Q_bias = 0.003; // Process noise variance for the gyro bias
		R_measure = 0.000001; // Measurement noise variance - this is actually the variance of the measurement noise
		angle = 0;
		bias = 0;
		rate = 0;
		y = 0;
