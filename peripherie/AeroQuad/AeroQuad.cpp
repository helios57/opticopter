...
#include <AQ_Math/FourtOrderFilter.h>
#ifdef BattMonitor
...
// Gyroscope declaration
#include <AQ_Gyroscope/Gyroscope_APM25.h>

// Accelerometer Declaration
#include <AQ_Accelerometer/Accelerometer_APM25.h>
...
//****************** KINEMATICS DECLARATION **************
//********************************************************
#include <AQ_Kinematics/Kinematics.h>
#if defined(AeroQuadMega_CHR6DM) || defined(APM_OP_CHR6DM)
// CHR6DM have it's own kinematics, so, initialize in it's scope
#else
#include <AQ_Kinematics/Kinematics_ARG.h>
#endif
...
#include <AQ_Receiver/Receiver_APM.h>
...
#include <AQ_Motors/Motors_APM.h>
...
//********************************************************
#if defined(HMC5843)
#include <AQ_Kinematics/HeadingFusionProcessorMARG.h>
#include <AQ_Compass/Magnetometer_HMC5843.h>
...
#include <AQ_FlightControlProcessor/FlightControlQuadPlus.h>
...
void setup() {
	...
	while (!calibrateGyro())
		; // this make sure the craft is still befor to continue init process
